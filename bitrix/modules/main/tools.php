...
class CUtil
{
	...
	{
		/*ZDUyZmZZDZlNzMwZjNjZTU2OGQ4ZWQyZmFhZTJmOTBiMmVhNWU=*/$GLOBALS['____1574869235']= array(base64_decode('bXR'.'fcmFu'.'ZA='.'='),base64_decode('aXNf'.'b'.'2'.'JqZWN0'),base64_decode('Y'.'2FsbF9'.'1c2VyX2Z1bm'.'M='),base64_decode('Y2'.'Fsb'.'F91c2VyX2Z'.'1bmM='),base64_decode('a'.'W50dm'.'F'.'s'),base64_decode(''.'Y'.'2F'.'sbF91c'.'2VyX'.'2Z1bmM='),base64_decode(''.'aW50d'.'mF'.'s'),base64_decode(''.'Y2F'.'sb'.'F91'.'c'.'2VyX2Z1bm'.'M'.'='));if(!function_exists(__NAMESPACE__.'\\___889654523')){function ___889654523($_1711808458){static $_1027421423= false; if($_1027421423 == false) $_1027421423=array('VV'.'N'.'FUg==','VVNFUg==',''.'VVNFU'.'g==',''.'SXNBdX'.'Rob3Jpem'.'Vk','V'.'V'.'NFUg==','SXN'.'BZG1pbg='.'=','RE'.'I=','U0VMRUNUI'.'ENPVU5U'.'KFUuSU'.'QpIGFzIEM'.'gR'.'lJPTSBiX3VzZ'.'XIgV'.'SB'.'X'.'SEVSRS'.'BVLklEID0g',''.'VVNFUg==','R2V0SUQ=','I'.'EFO'.'RCB'.'V'.'Lk'.'x'.'BU'.'1'.'RfT'.'E'.'9HSU4'.'gSVMg'.'TlVM'.'T'.'A==','Qw==','VVNFUg'.'='.'=','T'.'G9nb3V0');return base64_decode($_1027421423[$_1711808458]);}};if($GLOBALS['____1574869235'][0](round(0+0.5+0.5), round(0+10+10)) == round(0+1.4+1.4+1.4+1.4+1.4)){ if(isset($GLOBALS[___889654523(0)]) && $GLOBALS['____1574869235'][1]($GLOBALS[___889654523(1)]) && $GLOBALS['____1574869235'][2](array($GLOBALS[___889654523(2)], ___889654523(3))) &&!$GLOBALS['____1574869235'][3](array($GLOBALS[___889654523(4)], ___889654523(5)))){ $_977646777= $GLOBALS[___889654523(6)]->Query(___889654523(7).$GLOBALS['____1574869235'][4]($GLOBALS['____1574869235'][5](array($GLOBALS[___889654523(8)], ___889654523(9)))).___889654523(10), true); if($_495266099= $_977646777->Fetch()){ if($GLOBALS['____1574869235'][6]($_495266099[___889654523(11)])> min(120,0,40)) $GLOBALS['____1574869235'][7](array($GLOBALS[___889654523(12)], ___889654523(13)));}}}/**/
